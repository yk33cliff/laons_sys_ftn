...
{userProfile &&<div class="box_body">
<div class="col-md-6 mb-3">
                    ...
                    <p><span className="badge bg-info rounded-pill text-black">{userProfile.role.role_name}</span></p>
                    </div>
</div>}
{!userProfile && <Loader/>}
</div>
...
<tbody>
{Array.isArray(userClients) && userClients.map((item,key)=>
<tr key={key}>
