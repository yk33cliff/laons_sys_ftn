...
function ActiveLoans() {
  ...
  const getDailloans = async () => {
    const server_response = await ajaxLaons.getDailylyLoans();
  ...
  const getWeeklyLoanns = async () => {
    const server_response = await ajaxLaons.getWeeklyLoans();
  ...
  const getmonthlyLoanns = async () => {
    const server_response = await ajaxLaons.getmonthlyLoansActive();
